...
!(function () {
  ...
  function t() {
    if (!z && document.body) {
      ...
      (H = document.compatMode.indexOf("CSS") >= 0 ? o : t),
        (S = t),
        e(),
        top != self && (C = !0),
        M.fixedBackground ||
      ...
      var l = e === document.body,
        i = function (n) {
          ...
          l
            ...
            t || o || (A = []),
            A.length ? R(i, e, 1e3 / M.frameRate + 1) : (K = !1);
        };
      R(i, e, 0), (K = !0);
    }
  }
  function n(e) {
    ...
    return (
      ...
      !M.touchpadSupport && p(i)
        ? !0
        : (Math.abs(r) > 1.2 && (r *= M.stepSize / 120),
  ...
  function a(e) {
    ...
    if (
      ...
      return !0;
    if (
      (f(t, "button") || (f(t, "input") && r.test(t.type))) &&
  ...
  function g(e) {
    return e >= 1
      ...
      : 0 >= e
      ? 0
      : (1 == M.pulseNormalize && (M.pulseNormalize /= y(1)), y(e));
  }
  var S,
    k,
    D,
  ...
  "onwheel" in document.createElement("div")
    ? (O = "wheel")
    : "onmousewheel" in document.createElement("div") && (O = "mousewheel"),
    O && (m(O, n), m("mousedown", r), m("load", t));
})();
